...
import ctci.chapter1.IsPalindromePermutation._
import ctci.chapter1.IsPalindromePermutation
...
def main = 
    ...
    println(isPalindromePerm("rcaecar")) //true
    println(isPalindromePerm("rcaeicar")) // false

    println(isPalindromePerm("taco cat")) //true
    println(isPalindromePerm("")) //true
